...
func (*CMsgClientHeartBeat) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{0}
}
...
func (*CMsgClientLogon) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{1}
}
...
func (*CMsgClientLogonResponse) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{2}
}
...
func (*CMsgClientLogOff) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{5}
}
...
func (*CMsgClientLoggedOff) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{6}
}
...
func (*CMsgClientNewLoginKey) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{7}
}
...
func (*CMsgClientNewLoginKeyAccepted) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{8}
}
...
func (*CMsgClientAccountInfo) Descriptor() ([]byte, []int) {
	return client_server_login_fileDescriptor0, []int{9}
}
...
func init() {
	proto.RegisterFile("steammessages_clientserver_login.proto", client_server_login_fileDescriptor0)
}
